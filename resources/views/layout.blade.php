...
@if(Session::has('msg'))
<script>swal("Success!", "{{Session::get('msg')}}!", "success")</script>
@endif
<div id="mySidenav" class="sidenav">
  ...
  <li class="active">
      <a href="/userdash" class="a" style="background-color:#117864"><span class="fa fa-qrcode"></span>Dashboard</a>
    </li>
    <li class="active">
      <a href="/" class="a"><span class="fa fa-home"></span>Home</a>
    </li>
    <li>
      <a href="/profile/{{session::get('idu')}}" class="a"><span class="fa fa-user"></span>My Profile</a>
    </li>
    <li>
        <a href="user/logout" class="a"><span class="fas fa-sign-out-alt"></span>Logout</a>
    </li>
    </ul>
</div>
